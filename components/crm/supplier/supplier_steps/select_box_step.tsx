...
import SupplierDropDownDataStep from "./select_box_dropdown_data";
export default function SupplierSelectBoxStep({
  title = "",
  value = "Tất cả",
  placeholder = "",
  data = [],
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isOpen && <SupplierDropDownDataStep data={data} value={value}/>}
      </span>
    </div>
  );
}
