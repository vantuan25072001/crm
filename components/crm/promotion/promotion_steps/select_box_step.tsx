...
import PromotionDropDownDataStep from "./select_box_dropdown_data";
export default function PromotionSelectBoxStep({
  title = "",
  value = "Tất cả",
  placeholder = "",
  data = [],
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isOpen && <PromotionDropDownDataStep data={data} value={value}/>}
      </span>
    </div>
  );
}
