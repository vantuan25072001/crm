...
const TableDataQuotePromotion2: React.FC<TableDataOrderPromotionProps> = () => {
  ...
  const columns: ColumnsType<DataType> = [
    {
      title: <div><Checkbox></Checkbox> Mã CTKM</div>,
      width: 48,
      dataIndex: "maKM",
      key: "maKM",
      render:(text:string)=><div><Checkbox></Checkbox> {text}</div>
    },
    {
      title: "Tên CTKM",
      width: 100,
...
export default TableDataQuotePromotion2;
