...
import styles from "./campaign_detail_action.module.css";
import CampaignDetailDropDown from "./campaign_detail_dropdown";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isOpen && <CampaignDetailDropDown valueSelect={valueSelect} setValueSelect={setValueSelect} />}
      </span>
    </div>
  );
}
