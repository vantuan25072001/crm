...
const UpdateEmailFormList: React.FC = () => {
  ...
  useEffect(() => {
    setHeaderTitle("Mẫu sms / Thêm mới");
  ...
  return (
    <>
      ...
      <div className={styleHome.main} ref={mainRef}>
        <div className={style.main__title}>Thêm mới mẫu sms</div>
        ...
        <FooterAddSMSForm
          link="/marketing/sms"
          titleCancel="Hủy thêm mới mẫu sms"
          title="Thêm mới mẫu sms thành công!"
          contentCancel="Bạn có chắc chắn muốn hủy thêm mới mẫu sms thông tin bạn nhập sẽ không được lưu lại?"
        />
      </div>
    </>
  );
