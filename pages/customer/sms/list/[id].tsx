...
import SMS_potential from "@/components/crm/potential/detail/sms_potential";
  ...
  return (
    <>
      <Head>
        ...
        <title>Danh sách SMS khách hàng </title>
        <meta
          name="description"
      ...
      <CustomerHeaderTab activeName={"SMS"} />
