...
export default function AddContactData() {
  ...
  useEffect(() => {
    setHeaderTitle(`${id} / Liên hệ / Thêm mới`);
  ...
  return (
    <>
      <Head>
        ...
        <title>Thêm mới liên hệ khách hàng</title>
        <meta
          name="description"
            ...
            <div className={styles.info_step}>
              ...
              <div className={styles.form_add_potential}>
                ...
                <PotentialFooterAddFiles
                  ...
                  titleCancel="Xác nhận hủy thêm mới liên hệ"
                  title="Thêm mới liên hệ thành công!"
                  contentCancel="Bạn có chắc chắn muốn hủy thêm mới liên hệ Tran Quang Duc Dung?"
                />
              </div>
            </div>
          </div>
