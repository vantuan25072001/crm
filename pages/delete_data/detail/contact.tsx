...
import { ColumContact } from "@/components/crm/delete_data/colums_field/contact";
import { dataPotential } from "@/components/crm/delete_data/colums_field/data";
import Table_Contact from "@/components/crm/table_delete/table-contact-delete";
  ...
  return (
    <>
      <Head>
        ...
        <title>Dữ liệu đã xoá của Liên hệ</title>
        <meta
          name="description"
