...
import { Columbill } from "@/components/crm/delete_data/colums_field/bill";
import { dataPotential } from "@/components/crm/delete_data/colums_field/data";
import Table_Bill from "@/components/crm/table_delete/table-bill-delete";
  ...
  return (
    <>
      <Head>
        ...
        <title>Dữ liệu đã xoá của Hoá đơn</title>
        <meta
          name="description"
