...
import Table_Potential from "@/components/crm/table_delete/table-potential-delete";
import { ColumPotential } from "@/components/crm/delete_data/colums_field/potential";
  ...
  return (
    <>
      <Head>
        ...
        <title>Dữ liệu đã xoá của Tiềm năng</title>
        <meta
          name="description"
