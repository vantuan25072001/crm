...
import { ColumFormSms } from "@/components/crm/delete_data/colums_field/form_sms";
import { dataPotential } from "@/components/crm/delete_data/colums_field/data";
import Table_Form_Sms from "@/components/crm/table_delete/table-form_sms-delete";
  ...
  return (
    <>
      <Head>
        ...
        <title>Dữ liệu đã xoá của Mẫu SMS</title>
        <meta
          name="description"
